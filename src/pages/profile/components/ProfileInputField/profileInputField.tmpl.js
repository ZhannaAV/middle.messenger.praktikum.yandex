...
export const profileInputFieldTmpl = ({value, name, label, type, isRequired, isError}) => `
        ...
        <span class="profile-field__input-error ${isError && "profile-field__input-error_visible"}">${errors[name]}</span>
`